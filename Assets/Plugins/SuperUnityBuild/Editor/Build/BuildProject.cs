...
public static class BuildProject
{
    ...
    private static bool BuildPlayer(string notification, BuildReleaseType releaseType, BuildPlatform platform, BuildArchitecture architecture, BuildDistribution distribution, DateTime buildTime, BuildOptions options, string configKey)
    {
        ...
        // Get project options
        PlayerSettings.SetIncrementalIl2CppBuild(platform.targetGroup, releaseType.incrementalGC);
        PlayerSettings.SetIl2CppCompilerConfiguration(platform.targetGroup, (Il2CppCompilerConfiguration)System.Enum.Parse(typeof(Il2CppCompilerConfiguration), releaseType.cppCompilerConfiguration.ToString()));
        ...
        if (releaseType.waitForManagedDebugger)

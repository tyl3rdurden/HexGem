//Via: https://github.com/markv12/AutomaticSceneDropdownDemo
...
namespace KingdomOfNight
{
    public partial class SceneLoader
    {
        ...
        public static void GenerateSceneLoadMenuCode()
        {
            ...
            void AddCodeForDirectory(DirectoryInfo directoryInfo, StringBuilder result1)
            {
                ...
                for (int i = 0; i < fileInfoList.Length; i++)
                {
                    ...
                    {
                        AddCodeForFile(fileInfo, result1);
                    }
                }
                ...
                {
                    AddCodeForDirectory(subDirectories[i], result1);
                }

                void AddCodeForFile(FileInfo fileInfo, StringBuilder result2)
                {
                    ...
                    result2.Append("        [MenuItem(\"Scenes/").Append(subPath.Replace(".unity", "")).Append("\")]")
                        .Append(Environment.NewLine);
                    result2.Append("        public static void Load").Append(functionName).Append("() { OpenScene(\"")
